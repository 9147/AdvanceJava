...
public class prob5 {
    public static void main(String[] args) {
        File inpFile = new File("E://Advanced Java//Prob 5//file1.txt");
        File encFile = new File("E://Advanced Java//Prob 5//file2.txt");
        File decFile = new File("E://Advanced Java//Prob 5//file3.txt");
